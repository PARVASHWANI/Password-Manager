...
class MainApplication:
    ...
    def __init__(self, master):
        ...
        self.master.iconbitmap("D:\PYTHON PROGRAMS\Password Manager/passmgr.ico")

        self.loginLabel = tk.Label(self.master, text="*_* LOGIN *_*", width=3, height=2, font=self.large_font)
        ...
        self.bottonLog = tk.Button(self.master, text="Proceed", width=40, height=3,bg='#333',fg='white', cursor="hand2", font=self.small_font, command=lambda:self.log_in())
    ...
    def passwordStorageWindow(self):
        ...
        self.passwordsScreen.iconbitmap("D:\PYTHON PROGRAMS\Password Manager/passmgr.ico")
        ...
        self.nameLabel = tk.Label(self.frame1, text="Username:", font=self.large_font)
        ...
        self.savePasswordButton = tk.Button(self.frame1, text="Click Here To Save", width=20, height=3, cursor="hand2",bg='#333',fg='white', font=('Arial', 13), command=lambda: self.insertNewPassword())
        ...
        self.passwordsList.heading("#0", text="Username")
